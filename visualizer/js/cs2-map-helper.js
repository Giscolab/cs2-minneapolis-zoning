(function (App) {
  ...
  function update(context, state) {
    ...
    ensureCs2PngContractUi(context);
    ensureExportBundleUi(context);

    context.cs2PngContractOutput = byId("cs2-helper-png-contract");
    context.exportBundleOutput = byId("cs2-helper-export-bundle");

    setText(context.timelineManifestOutput, timelineManifest);
    setText(context.cs2PngContractOutput, cs2PngContract);
    setText(context.timelineConfigOutput, timelineConfig);
    setText(context.exportBundleOutput, exportBundleManifest);
    setText(context.cs2PngContractOutput, cs2PngContract);
